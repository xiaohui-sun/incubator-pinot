 ...
 */
public class DetectionTimeSeries {
  private DataFrame df;

  public DetectionTimeSeries() {
  ...
  public static DetectionTimeSeries fromDataFrame(DataFrame df) {
    DetectionTimeSeries ts = new DetectionTimeSeries();
  ...
  public DetectionTimeSeries merge(DetectionTimeSeries other) {
    df.append(other.df);
    return this;
  }
}
