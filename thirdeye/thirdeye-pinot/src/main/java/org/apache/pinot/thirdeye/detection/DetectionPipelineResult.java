...
public class DetectionPipelineResult {
  ...
  public DetectionPipelineResult(List<MergedAnomalyResultDTO> anomalies, DetectionTimeSeries predictions, long lastTimestamp) {
    this.anomalies = anomalies;
  ...
  public DetectionPipelineResult setPredictions(DetectionTimeSeries predictions) {
    this.predictions = predictions;
    return this;
  }
